    ...
    class WerewolfGame
    {
        ...
        private void InitActions()
        {
            ...
            if (_db.Actions.Count() == 0) {
                ...
                // nightVote.Roles.Add(GetRoleByName("Werewolf"));
                // nightVote.Roles.Add(GetRoleByName("Werewolf Shaman"));
                // nightVote.Roles.Add(GetRoleByName("Alpha Werewolf"));
                // nightVote.Roles.Add(GetRoleByName("Werewolf Seer"));
